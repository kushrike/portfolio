...
export const siteConfig = {
  ...
  about: {
    ...
    resumeUrl: 'https://drive.google.com/uc?export=download&id=1S_mMYX-_DWjDzpeMTxMXYJQ-aYQ98L-B',
    resumeUrl_pdf: 'https://drive.google.com/uc?export=download&id=1S_mMYX-_DWjDzpeMTxMXYJQ-aYQ98L-B',
  },
  experience: [
    {
      company: 'Zluri',
    ...
    },
    {
      ...
      logo: '/zluri.svg',
      highlights: [
        'Shipped out my <b>first critical feature</b>, providing insights for privileged users during access reviews within <b>2 weeks</b>.',
  ...
  projects: [
    ...
    },
    {
      ...
      description: 'A group project where I built a Distributed File System composed of a master server, some chunkservers and a number of clients. Includes file‑handling strategies at chunkserver level; handled multilevel failure cases.',
    ...
    },
    {
      ...
      colors: ['#2563eb', '#22c55e', '#f97316'],
      badges: ['Python', 'Flask', 'MongoDB', 'Javascript', 'OpenCV'],
    },
    {
      name: 'BIT Insider',
  ...
  recommendations: [
    {
      text: 'Kushal has been an integral part of IGA\'s success, consistently bringing dedication, technical depth, and a strong sense of ownership to everything he does. Beyond that, Kushal has a keen eye for identifying suboptimal code and proactively improving it—making our systems cleaner, more efficient, and more maintainable. His drive to raise the bar has made a lasting impact on the team and the codebase.',
    ...
    {
      text: 'I worked closely with Kushal and mentored him on his internship project, and I was consistently impressed by his dedication, technical expertise, and collaborative spirit. His ability to think critically and find innovative solutions greatly contributed to the project\'s success he worked on. What truly stood out about Kushal was his commitment to learning and growth. He eagerly embraced new challenges and consistently sought opportunities to expand his skillset. He was always willing to share insights and collaborate with colleagues. I wholeheartedly recommend them for any software-related role. He is not only a talented engineer but also a pleasure to work with. I have every confidence that they will continue to excel and make significant contributions wherever they go.',
      name: 'Shikhar Sharma',
    ...
    {
      text: 'Kushal is a highly motivated and skilled developer who thrives on tackling complex and challenging problems. He has a keen eye for detail and a strong ability to identify potential issues early on—often leading to faster, more stable outcomes. His contributions consistently added value to our projects and helped maintain high code quality across the board. What truly sets Kushal apart is his excellent communication skills and strong sense of ownership. He ensures that stakeholders are always informed and involved, which greatly improves collaboration and trust within the team.',
      name: 'Faizal Shaikh',
